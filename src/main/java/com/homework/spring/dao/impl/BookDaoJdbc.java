...
public class BookDaoJdbc implements BookDao {
    ...
    public com.homework.spring.dto.Book getById(long id) {
        return namedParameterJdbcOperations.queryForObject("select b.id, b.title, b.number_of_pages," +
                        ...
                        "BOOK b left join AUTHOR a on b.author_id = a.id left join GENRE g on b.genre_id = g.id" +
    ...
    private class BookMapper implements RowMapper<com.homework.spring.dto.Book> {

        @Override
        public com.homework.spring.dto.Book mapRow(ResultSet rs, int rowNum) throws SQLException {
            com.homework.spring.dto.Book book = new com.homework.spring.dto.Book();
            ...
            book.setAuthorFatherName(rs.getString("AUTHOR_FATHER_NAME"));
            book.setAuthorDateOfBirth(rs.getString("AUTHOR_DATE_OF_BIRTH"));
