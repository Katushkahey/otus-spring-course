...
insert into BOOK (id, title, number_of_pages, year_of_publishing, author_id, genre_id) values (4, 'Evgenii Onegin', 230, 1832, 1, 3);
insert into BOOK (id, title, number_of_pages, year_of_publishing, author_id, genre_id) values (5, 'Horoshee otnoshenie k loshadyam', 1, 1918, 2, 2);
insert into BOOK (id, title, number_of_pages, year_of_publishing, author_id, genre_id) values (6, 'Voina i mir', 1274, 1869, 3, 3);